...
function Home() {
  ...
  const listUsers = () => {
    axios
      .get(`http://localhost:3020/api/v1/users`)
      .then((res) => {
  ...
  const handleCreateUser = () => {
    axios
      .post(`http://localhost:3020/api/v1/users`, newUsers)
      .then((res) => {
  ...
  const handleUpdateUser = () => {
    axios
      .put(`http://localhost:3020/api/v1/users/${editUser.id_users}`, editUser)
      .then((res) => {
        console.log(res.data);
        listUsers();
        handleClose();
  ...
  const handleDelete = (id) => {
    axios
      .delete(`http://localhost:3020/api/v1/users/${id}`)
      .then((res) => {
          ...
          <Modal show={show} onHide={() => setShow(false)}>
            ...
            <Modal.Body>
              <div className="them">
                ...
                <p>Description</p>
                <input type="text" name="description" onChange={handleCreat} />
              </div>
            </Modal.Body>
            <Modal.Footer>
